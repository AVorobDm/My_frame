...
#
#     def __innit__(self, objective, _, class_num, **kwargs):
#         if objective == 'binary':
...
#                batch_norm=False, dropout=0.5, opty=None, learning_rate=0.01, ):
#         model = keras.models.Sequential()
#
#         # model.add(keras.layers.Dense(input_shape=input_shape, ))
#
...
#
#         model.compile(loss=self.loss, optimizer=OPT_MAP[opty](lr=learning_rate), metric=self.metric)
#
#         return model
#
#
